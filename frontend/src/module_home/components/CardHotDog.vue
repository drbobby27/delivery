...
<template>
    <div class="row px-5">
        ...
        <div class="productsHotDog">
            <div v-for="item in products" :key="item.id">
                <div class="card mb-3" style="max-width: 18rem;" v-if="item.category.type === 'Perro Caliente'">
...
.productsHotDog .card:hover img {
    width: 100%;
    transform: scale(1.09) rotateY(0);
}

.productsHotDog .card img {
    width: 180%;
    height: 11rem;
    object-fit: cover;
